...
sudo dmsetup -v create encrypted --table "0 $(sudo blockdev --getsize ${LOOP_DEV}) crypt aes-cbc-essiv:sha256 babebabebabebabebabebabebabebabe 0 ${LOOP_DEV} 0" --verifyudev
